 ...
 */
public class MyArrayList03<AnyType> implements Iterable<AnyType> {
    ...
    private static class ArrayListIterator<AnyType> implements Iterator<AnyType>{
        ...
        private MyArrayList03<AnyType> theList;

        public ArrayListIterator(MyArrayList03<AnyType> list) {
            this.theList = list;
        }
